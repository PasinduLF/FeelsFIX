    ...
    <div className='min-h-screen bg-white border-r'>
        {
            aToken && <ul className='text-[#515151] mt-5'>
                ...
                <NavLink className={({isActive})=>`flex items-center gap-3 py-3.5 px-3 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/add-workshop'}>
                    <img src={assets.add_icon} alt="" />
                    <p className='hidden md:block'>Add Workshop</p>
                </NavLink>
                <NavLink className={({isActive})=>`flex items-center gap-3 py-3.5 px-3 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/workshop-bars'}>
                    <img src={assets.list_icon} alt="" />
                    <p className='hidden md:block'>Workshops</p>
                </NavLink>
                <NavLink className={({isActive})=>`flex items-center gap-3 py-3.5 px-3 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/workshop-registrations'}>
                    <img src={assets.list_icon} alt="" />
                    <p className='hidden md:block'>Workshop Registrations</p>
                </NavLink>
                ...
                <NavLink className={({isActive})=>`flex items-center gap-3 py-3.5 px-3 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/payments'}>
                    <img src={assets.people_icon} alt="" />
                    <p className='hidden md:block'>Payments</p>
                </NavLink>
                <NavLink className={({isActive})=>`flex items-center gap-3 py-3.5 px-3 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to={'/inquiry'}>
                    <img src={assets.people_icon} alt="" />
